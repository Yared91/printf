 ...
 * @ind: Starting number in the buffer index
 * @buffer: Buffer input
 * @flags: Flags input
 * @width: width input
 * @prec: Specifies precision
 * @length: length input
 * @padd: Pading character input
...
/**
 * write_unsgnd - Function that writes unsigned number
 * @is_negative: Indicates if the num is negative
 * @ind: Starting number in the buffer index
 ...
 * @precision: Specifies precision
 * @size: Specifies size
 * Return: Prints written characters
 */
 ...
 * @width: Specifies width
 * @flags: Specifies flags
 * @padd: Represents padding characters
 * @extra_c: Represents extra characters
 * @padd_start: Starting number in the padding index
